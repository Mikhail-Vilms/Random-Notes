...
- Consistent hashing is mush better than MOD hashing, as significantly smaller fractionm of keys is re-hashed when new host is added or host is removed from the cache cluster
